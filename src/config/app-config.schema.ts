...
const DEFAULT_PRICE_CACHE_FRESH_TTL_SEC = 60;
const DEFAULT_PRICE_CACHE_STALE_TTL_SEC = 600;
const DEFAULT_PRICE_HISTORY_CACHE_MAX_ENTRIES = 5000;
const DEFAULT_PRICE_HISTORY_CACHE_TTL_SEC = 86_400;
const DEFAULT_PRICE_HISTORY_CACHE_STALE_SEC = 604_800;
const DEFAULT_PRICE_HISTORY_RANGE_MAX_AGE_DAYS = 90;
...
const DEFAULT_RATE_LIMIT_COINGECKO_HISTORY_MIN_TIME_MS = 6000;
const DEFAULT_RATE_LIMIT_COINGECKO_HISTORY_MAX_CONCURRENT = 1;
...
export const envSchema = z.object({
  ...
  PRICE_HISTORY_CACHE_MAX_ENTRIES: z.coerce
    .number()
    .int()
    .positive()
    .default(DEFAULT_PRICE_HISTORY_CACHE_MAX_ENTRIES),
  PRICE_HISTORY_CACHE_TTL_SEC: z.coerce
    .number()
    .int()
    .positive()
    .default(DEFAULT_PRICE_HISTORY_CACHE_TTL_SEC),
  PRICE_HISTORY_CACHE_STALE_SEC: z.coerce
    .number()
    .int()
    .positive()
    .default(DEFAULT_PRICE_HISTORY_CACHE_STALE_SEC),
  PRICE_HISTORY_RANGE_MAX_AGE_DAYS: z.coerce
    .number()
    .int()
    .positive()
    .default(DEFAULT_PRICE_HISTORY_RANGE_MAX_AGE_DAYS),
  ...
  RATE_LIMIT_COINGECKO_HISTORY_MIN_TIME_MS: z.coerce
    .number()
    .int()
    .min(0)
    .default(DEFAULT_RATE_LIMIT_COINGECKO_HISTORY_MIN_TIME_MS),
  RATE_LIMIT_COINGECKO_HISTORY_MAX_CONCURRENT: z.coerce
    .number()
    .int()
    .positive()
    .default(DEFAULT_RATE_LIMIT_COINGECKO_HISTORY_MAX_CONCURRENT),
