...
export class TronChainStreamService extends BaseChainStreamService {
  ...
  protected isWatcherEnabled(): boolean {
    return this.appConfigService.tronWatcherEnabled;
  }
  ...
  protected async resolveTrackedAddresses(): Promise<readonly string[]> {
    return this.subscriptionsRepository.listTrackedAddresses(ChainKey.TRON_MAINNET);
  }
  ...
  protected async classifyTransaction(
    ...
    return this.tronEventClassifierService.classify(context).event;
  }
}
